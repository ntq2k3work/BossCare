          ...
          <header className="flex flex-wrap items-start justify-between gap-4 pt-1">
            <div>
              <nav className="mb-7 flex items-center gap-3 text-sm font-semibold text-slate-500">
                ...
                <span>{copy.health.title}</span>
              </nav>
              <h1 className="text-3xl font-black tracking-tight text-slate-950 md:text-4xl">{copy.health.title}</h1>
              <p className="mt-3 text-base text-slate-500">{copy.health.description}</p>
            </div>
            <div className="flex flex-wrap items-center gap-4">
              ...
              <ButtonLink href={`/dashboard/pets/${pet.id}/health`} className="min-h-14 gap-2 rounded-lg px-6">
